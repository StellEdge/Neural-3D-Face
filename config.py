...
class BaseOptions():
    ...
    def initialize(self):
        ...
        training.add_argument("--batch_size", type=int, default=1, help="batch sizes for each GPU. A single RTX2080 can fit batch=4, chunck=1 into memory.")
        ...
        training.add_argument("--r1", type=float, default=10, help="r1 regularization to the StyleGAN generator")
        
        training.add_argument("--g_reg_every", type=int, default=8, help="interval for applying path length regularization to the StyleGAN generator")
        ...
        training.add_argument("--g_lr", type=float, default=0.0001, help="learning rate")
        training.add_argument("--d_lr", type=float, default=0.0001, help="learning rate")
        ...
        training.add_argument("--RECON_L1_WEIGHT", type=float, default=2, help="weight of the RECON_L1_WEIGHT")
        training.add_argument("--RECON_VGG_WEIGHT", type=float, default=2, help="weight of the RECON_VGG_WEIGHT")

        training.add_argument("--RECON_LND_WEIGHT", type=float, default=0, help="weight of the RECON_LND_WEIGHT")
        training.add_argument("--RECON_APP_WEIGHT", type=float, default=0, help="weight of the RECON_APP_WEIGHT")
        training.add_argument("--RECON_GAN_WEIGHT", type=float, default=1, help="weight of the RECON_GAN_WEIGHT")

        training.add_argument("--TRANSFER_LND_WEIGHT", type=float, default=0.05, help="weight of the TRANSFER_LND_WEIGHT")
        training.add_argument("--TRANSFER_APP_WEIGHT", type=float, default=0.1, help="weight of the TRANSFER_APP_WEIGHT")
        training.add_argument("--TRANSFER_GAN_WEIGHT", type=float, default=1, help="weight of the TRANSFER_GAN_WEIGHT")

        training.add_argument("--interval_between_transfer", type=int, default=3, help="interval between transfer batch")
        ...
        training.add_argument("--use_landmark_loss_after_epoch", type=int, default=0,
                              help='how many epochs before applying landmark Loss')
